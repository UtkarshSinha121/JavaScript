...
// perimitive data types are stored in stack memory for example number, string, boolean, undefined, null, symbol, bigint
// when we change value of primitive data type it will create new copy of that variable in memory

// reference data types are stored in heap memory for example object, array, function
// when we change value of not primitive data type it will not create new copy of that variable in memory it will change the value of that variable in memory
